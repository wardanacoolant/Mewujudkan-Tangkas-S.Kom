...
playlist = sp.playlist('', fields=None, market=None, additional_types=('track', ))
...
pd.DataFrame(features).to_csv('D:\Codingan\Jetbrains\PycharmProjects\Spotify\Venv\Include\Data\hiphop.csv')